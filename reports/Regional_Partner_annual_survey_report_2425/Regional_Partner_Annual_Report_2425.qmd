...
We had a total of `{r} responders` responders from `{r} length(unique(partners$Q2))` regional partners for this survey. The overall NPS was `{r} NPS_reg$NPS ` with a customer satisfaction rate of `{r} cust_satis$cust_perc`%  [^1].
