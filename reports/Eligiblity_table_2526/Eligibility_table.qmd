...
Gradeleveltabs<-readRDS("data/final_table_data.rds")
...
school_summary2<-left_join(school_summary,
                           counts_filled,
                           by = c("DistrictID"="Dis", "SchoolID"="Sch"))  %>%
...
Schools highlighted in <span style="background-color: orange">orange</span> fall under the average enrollment and over the average eligibility percentages!
...
reactable(
  ...
  #filter by index for specific schools within a district
   ...
   #time series of application activity from last year here
     counts = colDef(
