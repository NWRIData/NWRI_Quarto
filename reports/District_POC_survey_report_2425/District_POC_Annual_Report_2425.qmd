...
combined_word_cloud<-DIS_Data %>%
  ...
  mutate(full_comm = str_to_lower(full_comm)) %>%
...
<div id="wordcloud-scroll" style="overflow-x: auto; white-space: nowrap;">
  <img src="wrd_wordcloud_Detractor.png" style="height: 300px; display: inline-block; margin-right: 10px;">
  <img src="wrd_wordcloud_Passive.png" style="height: 300px; display: inline-block; margin-right: 10px;">
  <img src="wrd_wordcloud_Promoter.png" style="height: 300px; display: inline-block;">
</div>

<script>
  window.addEventListener("DOMContentLoaded", function() {
    const scroller = document.getElementById("wordcloud-scroll");
