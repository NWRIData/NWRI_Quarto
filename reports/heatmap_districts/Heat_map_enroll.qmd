...
<div class="title-wrap">
  Enrollment &amp; Eligibility across Florida Schools 
  ...
  <img src="images/LCLearning_Primary RGB.png" 
       alt="LCLearning" width="350" height="100">
</div>
...
recent_weeks$perc_diff <- ifelse(recent_weeks$raw_diff == 0, 
                                 0, 
                                 recent_weeks$perc_diff)

recent_weeks$perc_diff <- ifelse(is.infinite(recent_weeks$perc_diff), 
                                 NA, 
                                 recent_weeks$perc_diff)
