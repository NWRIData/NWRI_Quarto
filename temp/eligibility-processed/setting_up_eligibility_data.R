...
nwri_all<-readRDS("reports/Eligiblity_table_2526/base_data/nwri_all_table_07082026.rds")
nwri_eligible<-readRDS("reports/Eligiblity_table_2526/base_data/nwri_eligible_table_07082026.rds")
